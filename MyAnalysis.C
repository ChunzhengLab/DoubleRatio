...
// include path
   ...
   gSystem->AddIncludePath("-I. -I$ROOTSYS/include -I$ALICE_ROOT -I$ALICE_ROOT/include  -I$ALICE_ROOT/macros -I$ALICE_ROOT/ANALYSIS -I$ALICE_PHYSICS/include -g ");
...
// analysis source to be compiled at runtime (if any)
   gROOT->ProcessLine(".L AliAnalysisTaskRdoubleRatio.cxx+g");
